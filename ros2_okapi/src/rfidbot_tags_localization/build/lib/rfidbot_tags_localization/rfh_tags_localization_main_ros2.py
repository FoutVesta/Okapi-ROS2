...
* Author: Justin Palm (ROS2 Humble) | Ported to ROS2 by ChatGPT
* Date: Oct/2025
"""
...
from rfidbot_tags_localization.srv import TagLocalizing  # Rename srv file for ROS2 naming conventions

# Import custom modules
from data_recorders.rfh_tags_localization_fix_power_rawdata_recorder import rfhFixPowerRecoder
from localizers.rfh_3d_recursive_bayes_localizer import rfh3DRBTagLoclizer
from localizers.phase_differ_localizer import phDiffTagLoclizer
from localizers.recursive_bayes_localizer_gpu_3d import GPU3DRBTagLoclizer
from libs.rfidbot_set_tags_location_marker import setaSingle3DMarker, setaSingleMarkerText
...
class RFHTagsLocalization(Node):
    ...
    def __init__(self):
        ...
        self.fixPowerRecorder = rfhFixPowerRecoder(1, None)
